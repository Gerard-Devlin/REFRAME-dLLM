...
mkdir -p "$RUN_DIR"
for name in REPO RUN_DIR MODE GPU_IDS MODEL_SIZES LIMIT BATCH_SIZE DEPTHS WIDTH REPEATS SNAPSHOTS MAX_NEW_TOKENS THRESHOLD PROMPTS MIN_FREE_GIB CONDA_ROOT CONDA_ENV HF_HOME HF_HUB_CACHE HF_DATASETS_CACHE; do
