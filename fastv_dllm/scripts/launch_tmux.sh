...
mkdir -p "$RUN_DIR"
for name in REPO MODE RUN_DIR GPU_IDS DATASET LIMIT MAX_NEW_TOKENS BLOCK_SIZE SMALL_BLOCK_SIZE THRESHOLD PRUNE_AFTER_LAYER SUPPORT_KEEP OBSERVE_LAYERS OBSERVE_KEEPS REQUIRE_IDLE CONDA_ROOT CONDA_ENV HF_HOME HF_HUB_CACHE HF_DATASETS_CACHE; do
